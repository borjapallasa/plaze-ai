...
export default function SignIn() {
  ...
  return <div className="min-h-screen">
      ...
      <div className="min-h-screen lg:flex">
        ...
        {/* Right side - Sign in form - Half width on desktop */}
        <div className="lg:w-1/2 bg-muted/40 p-6 lg:p-12 flex items-center justify-center">
          <div className="w-full max-w-md space-y-6">
            ...
            <div className="text-center flex items-center justify-center gap-2">
              <span className="text-xs text-muted-foreground italic">Powered by</span>
              <img src="/lovable-uploads/84b87a79-21ab-4d4e-b6fe-3af1f7e0464d.png" alt="plaze.ai" className="h-4 w-auto" />
            </div>
          </div>
        </div>
      </div>
