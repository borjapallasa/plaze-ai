...
import { Star, Users, Mail, Info, BookOpen, MessageCircle } from "lucide-react";
          ...
          <div className="flex gap-4 items-start">
            ...
            <div className="space-y-2">
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground">Expert in XYZ</p>
              </div>
              <div className="flex gap-2">
                ...
                <Badge variant="secondary" className="flex gap-1 items-center">
                  <Users className="w-3 h-3" /> 1.2k Members
                </Badge>
              </div>
            </div>
          </div>
