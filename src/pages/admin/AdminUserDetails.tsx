...
export default function AdminUserDetails() {
  ...
  const updateStatusMutation = useUpdateCommunitySubscriptionStatus();
  ...
  const handleSetInactive = (subscriptionId: string, subscriptionName: string) => {
    setSelectedSubscription({ id: subscriptionId, name: subscriptionName });
    setDialogOpen(true);
  };

  const handleConfirmSetInactive = () => {
  ...
  return (
    <>
                      ...
                      <div key={subscription.community_subscription_uuid} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex flex-col gap-1">
                          ...
                          {subscription.expert?.name && (
                            <span className="text-sm text-[#8E9196]">
                              Expert: {subscription.expert.name}
                            </span>
                          )}
                        </div>
      ...
      <UpdateSubscriptionStatusDialog
        ...
        onConfirm={handleConfirmSetInactive}
