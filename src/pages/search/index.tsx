    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 pt-24">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-muted-foreground mb-6">Found {getTotalResults()} results</p>
            ...
            <>
              ...
              {(activeTab === 'All' || activeTab === 'Products') && results.products.length > 0 && (
                <div className={activeTab !== 'All' ? '' : 'mb-10'}>
                  {activeTab === 'All' && <h2 className="text-xl font-semibold mb-4">Products</h2>}
              ...
              {(activeTab === 'All' || activeTab === 'Experts') && results.experts.length > 0 && (
                <div className={activeTab !== 'All' ? '' : 'mb-10'}>
                  {activeTab === 'All' && <h2 className="text-xl font-semibold mb-4">Experts</h2>}
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              ...
              {(activeTab === 'All' || activeTab === 'Communities') && results.communities.length > 0 && (
                <div className={activeTab !== 'All' ? '' : 'mb-10'}>
                  {activeTab === 'All' && <h2 className="text-xl font-semibold mb-4">Communities</h2>}
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {results.communities.map((community) => (
                      <div key={community.community_uuid} className="border rounded-lg overflow-hidden bg-card hover:shadow-md transition-shadow">
                        <div className="p-4">
                          <h3 className="font-medium text-lg">{community.name}</h3>
                          <p className="text-muted-foreground line-clamp-2 mt-1">{community.description}</p>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              {(activeTab === 'All' || activeTab === 'Jobs') && results.jobs.length > 0 && (
                <div>
                  {activeTab === 'All' && <h2 className="text-xl font-semibold mb-4">Jobs</h2>}
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {results.jobs.map((job) => (
                      <div key={job.job_uuid} className="border rounded-lg overflow-hidden bg-card hover:shadow-md transition-shadow">
                        <div className="p-4">
