...
export function Footer() {
  ...
  const aboutLinks = [
    ...
    { label: "Plaze AI, Inc.", href: "/company" },
    ...
    <footer className="mt-auto bg-background border-t">
      <div className="container max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8">
          {/* Left side - Logo and App Download */}
          <div className="flex flex-col items-center lg:items-start space-y-4 lg:min-w-[200px]">
            <div className="flex items-center space-x-2">
              <img 
                src="/lovable-uploads/80716e7b-7544-445b-b37e-00d4372310cd.png" 
                alt="Plaze AI" 
          ...
          <div className="flex items-center justify-center lg:justify-end gap-4 lg:min-w-[200px]">
            <a 
