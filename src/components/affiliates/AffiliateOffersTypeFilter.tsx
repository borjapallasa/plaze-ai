...
export function AffiliateOffersTypeFilter({ 
  ...
  return (
    <div className="flex items-center gap-1 w-full sm:w-auto">
      <span className="text-xs text-muted-foreground whitespace-nowrap hidden sm:inline">Filter by type:</span>
      <Select value={filterType} onValueChange={handleFilterChange}>
        <SelectTrigger className="w-full sm:w-[120px] h-8 text-xs bg-white border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
