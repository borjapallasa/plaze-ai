...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div className="relative flex items-center">
      <div className="absolute left-0 top-0 bottom-0 w-14 bg-gradient-to-r from-background via-background to-transparent z-10 pointer-events-none"
      ...
      <div className="absolute right-0 top-0 bottom-0 w-14 bg-gradient-to-l from-background via-background to-transparent z-10 pointer-events-none"
